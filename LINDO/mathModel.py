...
class Modell:
    ...
    def __init__(self, arr):
        ...
        self.Q_TIR = 24000 # pojemność auta, które transportuje surowiec (w kilogramach)
        ...
        for k in range(self.R):
            self.r.append(k)
            Gr = random.randint(500000, 1500000) # Produkcyjna moc zakładu produkcyjnego w l. na miesiąc
