...
with open('research2.txt', 'a') as plik:
    plik.write("For I=3; R=3; E=5; \n Starting values for Z1_R: {} \n"
               "Współczynnik produkcji V: {} \n" 
               "Zapotrzebowanie na produkkcję K {} \n".format(data["i3r3e5"].Z1_R, data["i3r3e5"].V, data["i3r3e5"].K))
    plik.close()
counter = 0
for counter in range(300):
    ...
    countOfConstraints = ((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E) + data["i3r3e5"].E + data["i3r3e5"].R +
                          data["i3r3e5"].R + 2 + (data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E))
    countOfDesitionVariables = ((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E) + (data["i3r3e5"].I * data["i3r3e5"].R) +
    ...
    constOfConstraint7 = (sum(itertools.chain(data["i3r3e5"].W, data["i3r3e5"].Z)) + sumaA + sum(data["i3r3e5"].A1_R__1_E_arr) +
    ...
    for iteratorR in range(data["i3r3e5"].R):
        temporary5 = ((sumColumn(data["i3r3e5"].A1_R__1_I, iteratorR) - data["i3r3e5"].Z1_R[iteratorR]) / data["i3r3e5"].V[iteratorR]
                      - data["i3r3e5"].Y[iteratorR] - sumRow(data["i3r3e5"].A1_R__1_E, iteratorR))
        constsOfConstraint5.append(temporary5)
        temporary4 = data["i3r3e5"].G[iteratorR] * data["i3r3e5"].V[iteratorR] + sumColumn(data["i3r3e5"].A1_R__1_I, iteratorR)
    ...
    for i in range((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)):
        ...
        indeks += 1
    constantsOfDecisionVariableOfConstrain7 += [0 for i in range((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E))]
    ...
    constantsOfDecisionVariableOfConstrain5 = \
        ([constantsOfDecisionVariableOfConstrain5arr[y:y + ((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) * 2]
    ...
    constantsOfDecisionVariableOfConstrain4 = \
        ([constantsOfDecisionVariableOfConstrain4arr[z:z + ((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) * 2]
    ...
    constantsOfDecisionVariableOfConstrain3 = \
        ([constantsOfDecisionVariableOfConstrain3arr[t:t + ((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) * 2]
    ...
    constantsOfDecisionVariableOfConstrain2 = \
        ([constantsOfDecisionVariableOfConstrain2arr[x:x + ((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) * 2]
    ...
    constantsOfDecisionVariableOfConstrain1 = \
        ([constantsOfDecisionVariableOfConstrain1arr[v:v + ((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) * 2]
    ...
    constantsOfDecisionVariableOfConstrain8 = \
        ([constantsOfDecisionVariableOfConstrain8arr[k:k + ((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) * 2]
    ...
    constantsOfDecisionVariableOfConstrain9 = \
        ([constantsOfDecisionVariableOfConstrain9arr[p:p + ((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) * 2]
    ...
    lowerBounds.extend(0 for i in range(((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) * 2))
    upperBounds.extend(1.0E+30 for i in range(((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) * 2))
    pointersToCharacters.extend('C' for i in range((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)))
    pointersToCharacters.extend('I' for i in range((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)))
    ...
    if len(constantsOfDecisionVariableOfConstrain7) == ((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) * 2:
    ...
    if count == ((data["i3r3e5"].I + data["i3r3e5"].E) * data["i3r3e5"].R) and \
                    allCount == ((((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) * 2) * data["i3r3e5"].R):
    ...
    if len(constantsOfDecisionVariableOfConstrain6) == ((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) * 2:
    ...
    if count == (data["i3r3e5"].R * data["i3r3e5"].E) and allCount == ((((data["i3r3e5"].I * data["i3r3e5"].R) +
                                                                 (data["i3r3e5"].R * data["i3r3e5"].E)) * 2) * data["i3r3e5"].E):
    ...
    if count == (data["i3r3e5"].I * data["i3r3e5"].R) and allCount == ((((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) * 2)
                                                               * (data["i3r3e5"].I * data["i3r3e5"].R)):
    ...
    if count == (data["i3r3e5"].R * data["i3r3e5"].E) and allCount == ((((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) * 2)
                                                               * (data["i3r3e5"].R * data["i3r3e5"].E)):
    ...
    if len(columnStartIndices) - 1 == ((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) * 2:
    ...
    if len(nonZeroCoeficients) == (((data["i3r3e5"].I * data["i3r3e5"].R) + (data["i3r3e5"].R * data["i3r3e5"].E)) +  # constraint 7
