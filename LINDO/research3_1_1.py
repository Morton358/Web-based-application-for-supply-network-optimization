...
data = {}
data["i5r3e8"] = mathModel.Modell([3, 3, 5])
print(data["i5r3e8"].W)
with open('research3.1.1.txt', 'a') as plik:
    plik.write("For I=3; R=3; E=5; \n Starting values for W: {} \n"
               "Współczynnik produkcji V: {} \n"
               "Zapotrzebowanie K: {} \n".format(data["i5r3e8"].W, data["i5r3e8"].V, data["i5r3e8"].K))
    plik.close()
counter = 0
for counter in range(500):
    ...
    countOfConstraints = (
    (data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E) + data["i5r3e8"].E + data[
        "i5r3e8"].R +
    data["i5r3e8"].R + 2 + (data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E))
    countOfDesitionVariables = ((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E) + (
    data["i5r3e8"].I * data["i5r3e8"].R) +
                                (data["i5r3e8"].R * data["i5r3e8"].E))

    sumaA = 0
    for i in range(data["i5r3e8"].I):
        for r in range(data["i5r3e8"].R):
            sumaA += (1 - 1 / data["i5r3e8"].V[r]) * data["i5r3e8"].A1_R__1_I[i][r]

    print('sumaA: ', sumaA)

    sumaZ = 0
    for r in range(data["i5r3e8"].R):
        sumaZ += 1 / data["i5r3e8"].V[r] * data["i5r3e8"].Z1_R[r]

    print('sumaZ: ', sumaZ)

    constOfConstraint7 = (
    sum(itertools.chain(data["i5r3e8"].W, data["i5r3e8"].Z)) + sumaA + sum(data["i5r3e8"].A1_R__1_E_arr) +
    sum(data["i5r3e8"].Y) + sumaZ)
    constOfConstraint6 = sum(data["i5r3e8"].A1_R__1_I_arr) + sum(itertools.chain(data["i5r3e8"].W, data["i5r3e8"].Z))
    constsOfConstraint5 = []
    constsOfConstraint4 = []
    constsOfConstraint3 = []
    constsOfConstraint2 = data["i5r3e8"].A1_R__1_E_arr
    constsOfConstraint1 = data["i5r3e8"].A1_R__1_I_arr
    constsOfConstraint8 = [0] * (data["i5r3e8"].I * data["i5r3e8"].R)
    constsOfConstraint9 = [0] * (data["i5r3e8"].R * data["i5r3e8"].E)

    for iteratorR in range(data["i5r3e8"].R):
        temporary5 = (
        (sumColumn(data["i5r3e8"].A1_R__1_I, iteratorR) - data["i5r3e8"].Z1_R[iteratorR]) / data["i5r3e8"].V[iteratorR]
        - data["i5r3e8"].Y[iteratorR] - sumRow(data["i5r3e8"].A1_R__1_E, iteratorR))
        constsOfConstraint5.append(temporary5)
        temporary4 = data["i5r3e8"].G[iteratorR] * data["i5r3e8"].V[iteratorR] + sumColumn(data["i5r3e8"].A1_R__1_I,
                                                                                           iteratorR)
        constsOfConstraint4.append(temporary4)

    for iteratorE in range(data["i5r3e8"].E):
        temporary3 = data["i5r3e8"].K[iteratorE] + sumColumn(data["i5r3e8"].A1_R__1_E, iteratorE)
    ...
    signsOfConstrain5 = [equalTo for i in range(data["i5r3e8"].R)]
    ...
    signsOfConstrain4 = [lessThenEqual for i in range(data["i5r3e8"].R)]
    signsOfConstrainExpressions.extend(signsOfConstrain4)
    signsOfConstrain3 = [greaterThenEqual for i in range(data["i5r3e8"].E)]
    signsOfConstrainExpressions.extend(signsOfConstrain3)
    signsOfConstrain1 = [greaterThenEqual for i in range(data["i5r3e8"].R * data["i5r3e8"].I)]
    signsOfConstrainExpressions.extend(signsOfConstrain1)
    signsOfConstrain2 = [greaterThenEqual for i in range(data["i5r3e8"].R * data["i5r3e8"].E)]
    signsOfConstrainExpressions.extend(signsOfConstrain2)
    signsOfConstrain8 = [lessThenEqual for i in range(data["i5r3e8"].R * data["i5r3e8"].I)]
    signsOfConstrainExpressions.extend(signsOfConstrain8)
    signsOfConstrain9 = [lessThenEqual for i in range(data["i5r3e8"].R * data["i5r3e8"].E)]
    signsOfConstrainExpressions.extend(signsOfConstrain9)

    constantsOfDecisionVariableOfConstrain7 = []
    constantsOfDecisionVariableOfConstrain6 = ([1 for i in range(data["i5r3e8"].I * data["i5r3e8"].R)] +
                                               [0 for i in range(data["i5r3e8"].R * data["i5r3e8"].E)] +
                                               [0 for i in range((data["i5r3e8"].I * data["i5r3e8"].R) +
                                                                 (data["i5r3e8"].R * data["i5r3e8"].E))])
    ...
    indeks = 0
    for i in range((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)):
        if indeks + 1 > data["i5r3e8"].R:
            indeks = 0
        constantsOfDecisionVariableOfConstrain7.append(1 - 1 / data["i5r3e8"].V[indeks])
        indeks += 1
    constantsOfDecisionVariableOfConstrain7 += [0 for i in range(
        (data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E))]

    for iter in range(data["i5r3e8"].R):
        constantsOfDecisionVariableOfConstrain5i1.append([0 for i in range(data["i5r3e8"].I * data["i5r3e8"].R)])
        constantsOfDecisionVariableOfConstrain5i2.append([0 for i in range(data["i5r3e8"].R * data["i5r3e8"].E)])
        constantsOfDecisionVariableOfConstrain5i3.append([0 for i in range(data["i5r3e8"].I * data["i5r3e8"].R)])
        constantsOfDecisionVariableOfConstrain5i4.append([0 for i in range(data["i5r3e8"].R * data["i5r3e8"].E)])
        constantsOfDecisionVariableOfConstrain4i1.append([0 for i in range(data["i5r3e8"].I * data["i5r3e8"].R)])
        constantsOfDecisionVariableOfConstrain4i2.append([0 for i in range(data["i5r3e8"].R * data["i5r3e8"].E)])
        constantsOfDecisionVariableOfConstrain4i3.append([0 for i in range(data["i5r3e8"].I * data["i5r3e8"].R)])
        constantsOfDecisionVariableOfConstrain4i4.append([0 for i in range(data["i5r3e8"].R * data["i5r3e8"].E)])

    for it in range(data["i5r3e8"].E):
        constantsOfDecisionVariableOfConstrain3i1.append([0 for i in range(data["i5r3e8"].I * data["i5r3e8"].R)])
        constantsOfDecisionVariableOfConstrain3i2.append([0 for i in range(data["i5r3e8"].R * data["i5r3e8"].E)])
        constantsOfDecisionVariableOfConstrain3i3.append([0 for i in range(data["i5r3e8"].I * data["i5r3e8"].R)])
        constantsOfDecisionVariableOfConstrain3i4.append([0 for i in range(data["i5r3e8"].R * data["i5r3e8"].E)])

    for itrator in range(data["i5r3e8"].I * data["i5r3e8"].R):
        constantsOfDecisionVariableOfConstrain1i1.append([0 for i in range(data["i5r3e8"].I * data["i5r3e8"].R)])
        constantsOfDecisionVariableOfConstrain1i2.append([0 for i in range(data["i5r3e8"].R * data["i5r3e8"].E)])
        constantsOfDecisionVariableOfConstrain1i3.append([0 for i in range(data["i5r3e8"].I * data["i5r3e8"].R)])
        constantsOfDecisionVariableOfConstrain1i4.append([0 for i in range(data["i5r3e8"].R * data["i5r3e8"].E)])
        constantsOfDecisionVariableOfConstrain8i1.append([0 for i in range(data["i5r3e8"].I * data["i5r3e8"].R)])
        constantsOfDecisionVariableOfConstrain8i2.append([0 for i in range(data["i5r3e8"].R * data["i5r3e8"].E)])
        constantsOfDecisionVariableOfConstrain8i3.append([0 for i in range(data["i5r3e8"].I * data["i5r3e8"].R)])
        constantsOfDecisionVariableOfConstrain8i4.append([0 for i in range(data["i5r3e8"].R * data["i5r3e8"].E)])

    for ittrator in range(data["i5r3e8"].R * data["i5r3e8"].E):
        constantsOfDecisionVariableOfConstrain2i1.append([0 for i in range(data["i5r3e8"].I * data["i5r3e8"].R)])
        constantsOfDecisionVariableOfConstrain2i2.append([0 for i in range(data["i5r3e8"].R * data["i5r3e8"].E)])
        constantsOfDecisionVariableOfConstrain2i3.append([0 for i in range(data["i5r3e8"].I * data["i5r3e8"].R)])
        constantsOfDecisionVariableOfConstrain2i4.append([0 for i in range(data["i5r3e8"].R * data["i5r3e8"].E)])
        constantsOfDecisionVariableOfConstrain9i1.append([0 for i in range(data["i5r3e8"].I * data["i5r3e8"].R)])
        constantsOfDecisionVariableOfConstrain9i2.append([0 for i in range(data["i5r3e8"].R * data["i5r3e8"].E)])
        constantsOfDecisionVariableOfConstrain9i3.append([0 for i in range(data["i5r3e8"].I * data["i5r3e8"].R)])
        constantsOfDecisionVariableOfConstrain9i4.append([0 for i in range(data["i5r3e8"].R * data["i5r3e8"].E)])
    ...
    for lists in constantsOfDecisionVariableOfConstrain5i1:
        ...
        while iterator < data["i5r3e8"].I * data["i5r3e8"].R:
            lists[iterator] = 1 / data["i5r3e8"].V[iteratorV]
            iterator += data["i5r3e8"].R
        iteratorV += 1
    ...
    for lists in constantsOfDecisionVariableOfConstrain5i2:
        indexOfLists += 1
        iterator = indexOfLists
        for i in range(data["i5r3e8"].E):
            lists[iterator] = -1
            iterator += 1
        indexOfLists += data["i5r3e8"].E - 1
    ...
    for lists in constantsOfDecisionVariableOfConstrain3i2:
        indexOfLists += 1
        iterator = indexOfLists
        while iterator < data["i5r3e8"].R * data["i5r3e8"].E:
            lists[iterator] = 1
            iterator += data["i5r3e8"].E
    ...
    for lists in constantsOfDecisionVariableOfConstrain8i1:
        indexOfLists += 1
        iterator = indexOfLists
        lists[iterator] = 1 / data["i5r3e8"].Q_TIR
    ...
    for lists in constantsOfDecisionVariableOfConstrain9i2:
        indexOfLists += 1
        iterator = indexOfLists
        lists[iterator] = 1 / data["i5r3e8"].Q
    ...
    for i in range(data["i5r3e8"].I * data["i5r3e8"].R):
    ...
    for i in range(data["i5r3e8"].R * data["i5r3e8"].E):
    ...
    constantsOfDecisionVariableOfConstrain5 = \
        ([constantsOfDecisionVariableOfConstrain5arr[
          y:y + ((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)) * 2]
          for y in range(0, len(constantsOfDecisionVariableOfConstrain5arr),
                         ((data["i5r3e8"].I * data["i5r3e8"].R) +
                          (data["i5r3e8"].R * data["i5r3e8"].E)) * 2)])
    constantsOfDecisionVariableOfConstrain4 = \
        ([constantsOfDecisionVariableOfConstrain4arr[
          z:z + ((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)) * 2]
          for z in range(0, len(constantsOfDecisionVariableOfConstrain4arr), ((data["i5r3e8"].I * data["i5r3e8"].R) +
                                                                              (data["i5r3e8"].R * data[
                                                                                  "i5r3e8"].E)) * 2)])
    constantsOfDecisionVariableOfConstrain3 = \
        ([constantsOfDecisionVariableOfConstrain3arr[
          t:t + ((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)) * 2]
          for t in range(0, len(constantsOfDecisionVariableOfConstrain3arr), ((data["i5r3e8"].I * data["i5r3e8"].R) +
                                                                              (data["i5r3e8"].R * data[
                                                                                  "i5r3e8"].E)) * 2)])
    constantsOfDecisionVariableOfConstrain2 = \
        ([constantsOfDecisionVariableOfConstrain2arr[
          x:x + ((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)) * 2]
          for x in range(0, len(constantsOfDecisionVariableOfConstrain2arr), ((data["i5r3e8"].I * data["i5r3e8"].R) +
                                                                              (data["i5r3e8"].R * data[
                                                                                  "i5r3e8"].E)) * 2)])
    constantsOfDecisionVariableOfConstrain1 = \
        ([constantsOfDecisionVariableOfConstrain1arr[
          v:v + ((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)) * 2]
          for v in range(0, len(constantsOfDecisionVariableOfConstrain1arr), ((data["i5r3e8"].I * data["i5r3e8"].R) +
                                                                              (data["i5r3e8"].R * data[
                                                                                  "i5r3e8"].E)) * 2)])

    constantsOfDecisionVariableOfConstrain8 = \
        ([constantsOfDecisionVariableOfConstrain8arr[
          k:k + ((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)) * 2]
          for k in range(0, len(constantsOfDecisionVariableOfConstrain8arr), ((data["i5r3e8"].I * data["i5r3e8"].R) +
                                                                              (data["i5r3e8"].R * data[
                                                                                  "i5r3e8"].E)) * 2)])

    constantsOfDecisionVariableOfConstrain9 = \
        ([constantsOfDecisionVariableOfConstrain9arr[
          p:p + ((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)) * 2]
          for p in range(0, len(constantsOfDecisionVariableOfConstrain9arr), ((data["i5r3e8"].I * data["i5r3e8"].R) +
                                                                              (data["i5r3e8"].R * data[
                                                                                  "i5r3e8"].E)) * 2)])
    ...
    lowerBounds.extend(
        0 for i in range(((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)) * 2))
    upperBounds.extend(
        1.0E+30 for i in range(((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)) * 2))
    pointersToCharacters.extend(
        'C' for i in range((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)))
    pointersToCharacters.extend(
        'I' for i in range((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)))

    J1_I_FIT = []
    for i in data["i5r3e8"].J1_I:
        for iteratorR in range(data["i5r3e8"].R):
            J1_I_FIT.append(i)

    J1_R_FIT = []
    for i in data["i5r3e8"].J1_R:
        for iteratorE in range(data["i5r3e8"].E):
            J1_R_FIT.append(i)
    ...
    J1_R__1_I_FIT.extend(list(map(mul, data["i5r3e8"].J1_R__1_I_arr, data["i5r3e8"].M1_R__1_I)))
    # J1_R__1_I_FIT = [round(elem, 2) for elem in J1_R__1_I_FIT]

    J1_R__1_E_FIT.extend(list(map(mul, data["i5r3e8"].J1_R__1_E_arr, data["i5r3e8"].M1_R__1_E)))
    ...
    if len(constantsOfDecisionVariableOfConstrain7) == (
        (data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)) * 2:
    ...
    if count == ((data["i5r3e8"].I + data["i5r3e8"].E) * data["i5r3e8"].R) and \
                    allCount == (
                (((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)) * 2) * data[
                "i5r3e8"].R):
    ...
    if count == (data["i5r3e8"].I * data["i5r3e8"].R) and \
                    allCount == (
                (((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)) * 2) * data[
                "i5r3e8"].R):
    ...
    if count == (data["i5r3e8"].R * data["i5r3e8"].E) and allCount == ((((data["i5r3e8"].I * data["i5r3e8"].R) +
                                                                             (data["i5r3e8"].R * data[
                                                                                 "i5r3e8"].E)) * 2) * data["i5r3e8"].E):
    ...
    if count == (data["i5r3e8"].I * data["i5r3e8"].R) and allCount == (
        (((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)) * 2)
        * (data["i5r3e8"].I * data["i5r3e8"].R)):
    ...
    if count == (data["i5r3e8"].R * data["i5r3e8"].E) and allCount == (
        (((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)) * 2)
        * (data["i5r3e8"].R * data["i5r3e8"].E)):
    ...
    if count == ((data["i5r3e8"].I * data["i5r3e8"].R) * 2) and \
                    allCount == ((((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)) * 2) *
                                     (data["i5r3e8"].I * data["i5r3e8"].R)):
    ...
    if count == ((data["i5r3e8"].R * data["i5r3e8"].E) * 2) and \
                    allCount == ((((data["i5r3e8"].I * data["i5r3e8"].R) + (data["i5r3e8"].R * data["i5r3e8"].E)) * 2) *
                                     (data["i5r3e8"].R * data["i5r3e8"].E)):
    ...
    # some other tests:
    if len(data["i5r3e8"].M1_R__1_I) == len(data["i5r3e8"].J1_R__1_I_arr):
        print("M1_R__1_I and J1_R__1_I_arr have the same length")
    else:
        print("M1_R__1_I AND J1_R__1_I_arr HAVE DIFFERENT LENGTH")

    if len(data["i5r3e8"].M1_R__1_E) == len(data["i5r3e8"].J1_R__1_E_arr):
    ...
    if len(nonZeroCoeficients) == (((data["i5r3e8"].I * data["i5r3e8"].R) + (
        data["i5r3e8"].R * data["i5r3e8"].E)) +  # constraint 7
                                       ((data["i5r3e8"].I + data["i5r3e8"].E) * data["i5r3e8"].R) +  # constraint 5
                                       (data["i5r3e8"].I * data["i5r3e8"].R) +  # constraint 6
                                       (data["i5r3e8"].I * data["i5r3e8"].R) +  # constraint 4
                                       (data["i5r3e8"].R * data["i5r3e8"].E) +  # constraint 3
                                       (data["i5r3e8"].I * data["i5r3e8"].R) +  # constraint 1
                                       (data["i5r3e8"].R * data["i5r3e8"].E) +  # constraint 2
                                       ((data["i5r3e8"].I * data["i5r3e8"].R) * 2) +  # constraint 8
                                       ((data["i5r3e8"].R * data["i5r3e8"].E) * 2)):  # constraint 9
